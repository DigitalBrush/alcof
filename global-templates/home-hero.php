...
$container = get_theme_mod( 'understrap_container_type' );
	...
	<section class="content-section">
		<div class="container-fluid vh-100" id="wrapper-static-content" tabindex="-1">
				...
				<div class="col-sm-6 hero-text">
					<div class="slider-text">
						...
						<div class="slider-body">
							...
							<a href="<?php echo esc_url(home_url('#')); ?>" class="btn btn-lg btn-secondary">Acheter maintenant</a>
						</div>
